...
public class Test {
	...
	public static void main(String[] args) {
		...
		for (Product product : new SortedInventory().productArraySorted(products)) {
		...
		Product p2 = binary.search(new SortedInventory().productArraySorted(products), 106);
		System.out.println(p2!=null ? p2.toString() : "Not found");
		
		System.out.print("Product with ID 101 (Binary Search): ");
		Product p3 = binary.search(new SortedInventory().productArraySorted(products), 101);
